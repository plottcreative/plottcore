...
namespace PLOTT_THEME\Inc\Traits;
...
trait Singleton
{
	 ...
	 *
	 * This is meant to be overridden in the classes with implement
	 * this trait. This is ideal for doing stuff that you only want to
	 * do once, such as hook into actions and filters, ect.
	 */
	...
	final public static function get_instance()
	{
		...
		if ( ! isset( $instance[$called_class] ) ){
			...
			/**
			 * Dependent items cas use the `plott_theme_singleton_init_{$called_class}` hook to execute code
			 */
			do_action( sprintf('plott_theme_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
		}
