...
class PLOTT_Nav_Walker extends \Walker_Nav_Menu
{

	use Singleton;

	/**
	 * Whether the items_wrap contains schema or not.
	 *
	 * @since 4.2.0
	 * @var boolean
	 */
	private bool $has_schema = true;

	/**
	 * Ensure the item_wrap argument contains microdata
	 */
	 ...
	 *
	 */
	function add_schema_to_navbar_ul($args)
	{
